...
<DropdownAccordion title="תוך כמה זמן אני נכנס לכושר שמספיק לעבור יום סיירות?" content="8. משתנה בין בנאדם לבנאדם ורק רמת הרצינות ההשקעה וההתמדה תקבע את קצב ההתקדמות שלך. ביום הסיירות אתה מתמודד מול נערים אחרים וגם כאלה שמתאמנים שנתיים ואף יותר ולכן אני ממליץ להתחיל כמה שיותר מוקדם (אצלנו ניתן להצטרף החל מגיל 15) אם זאת אני יכול לומר שיש לנו מתאמנים שגם לאחר חצי שנה הגיעו לכושר הנדרש ליום סיירות אבל מצד שני שמעתי גם על הרבה שהיו שאננים, חיכו וכשהיום סיירות הגיע הם לא היו מוכנים. אל תחכו! תתחילו היום!!" />
<Button2 text="שחריה , צרף אותי לקבוצה"/>
